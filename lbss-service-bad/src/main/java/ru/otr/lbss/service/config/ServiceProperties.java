...
public interface ServiceProperties {
	...
	final static String AntiDDOS_enable = "LBSS.AntiDDOS_enable";
	final static String AntiDDOS_counter = "LBSS.AntiDDOS_counter";
	final static String AntiDDOS_allowedPeriod = "LBSS.AntiDDOS_allowedPeriod";
