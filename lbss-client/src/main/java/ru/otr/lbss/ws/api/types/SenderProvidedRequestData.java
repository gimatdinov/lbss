...
@XmlType(name = "", propOrder = { "messageID", "referenceMessageID", "transactionCode", "nodeID", "eol", "messagePrimaryContent", "personalSignature",
        "attachmentHeaderList", "refAttachmentHeaderList", "businessProcessMetadata", "testMessage" })
