package ru.otr.lbss.model.mongodb;
...
import ru.otr.lbss.model.codec.RequestMessageCodec;
import ru.otr.lbss.model.codec.ResponseMessageCodec;
import ru.otr.lbss.model.codec.SmevMemberCodec;
import ru.otr.lbss.model.codec.StatusMessageCodec;
import ru.otr.lbss.service.config.LbssConfig;

public class LbssDBProvider {
	private static Logger log = LoggerFactory.getLogger(LbssDBProvider.class);
